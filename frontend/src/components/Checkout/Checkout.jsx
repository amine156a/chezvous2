  ...
  return (
    <div className="w-full 800px:w-[95%] bg-white rounded-md p-5 pb-8">
      ...
      <form>
        ...
        <div className="w-full flex pb-3">
          <div className="w-[85%]">
            <label className="block pb-2">Adresse</label>
            <input
              type="address"
              required
              value={address1}
      ...
      >
        Choisissez de l'Adresse Enregistrée
      </h5>
      {userInfo && (
        <div>
          {user &&
  ...
  return (
    <div className="w-full bg-[#fff] rounded-md p-5 pb-8">
      <div className="flex justify-between">
        ...
        <h5 className="text-[18px] font-[600]">DA{subTotalPrice}</h5>
      </div>
      <br />
      <div className="flex justify-between">
        <h3 className="text-[16px] font-[400] text-[#000000a4]">Livraison:</h3>
        <h5 className="text-[18px] font-[600]">Gratuite</h5>
      </div>
      <br />
      <div className="flex justify-between border-b pb-3">
        <h3 className="text-[16px] font-[400] text-[#000000a4]">Réduction:</h3>
        <h5 className="text-[18px] font-[600]">
          - {discountPercentenge ? "DA" + discountPercentenge.toString() : null}
        </h5>
      </div>
      <h5 className="text-[18px] font-[600] text-end pt-3">DA{totalPrice}</h5>
      <br />
